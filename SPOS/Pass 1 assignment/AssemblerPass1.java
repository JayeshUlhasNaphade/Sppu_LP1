...
public class AssemblerPass1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PrintWriter lclistWriter = new PrintWriter(new FileWriter("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 1 assignment\\output file\\lclist.txt"), true); //generate ST
    ...
    static void initializeTables() throws Exception {
        ...
        String s;
        BufferedReader br;
        br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 1 assignment\\input file\\mot.txt")));//reading MOT
        ...
        br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 1 assignment\\input file\\pot.txt")));//reading POT
        while ((s = br.readLine()) != null) {
    ...
    static void pass1() throws Exception {
        //Read Input file
        BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 1 assignment\\input file\\input.txt")));
        out_pass1 = new PrintWriter(new FileWriter("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 1 assignment\\output file\\output_pass1.txt"), true); //writing to Output file pass1
        PrintWriter out_symtable = new PrintWriter(new FileWriter("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 1 assignment\\output file\\out_symtable.txt"), true); //generate ST
        PrintWriter out_littable = new PrintWriter(new FileWriter("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 1 assignment\\output file\\output fileout_littable.txt"), true); //generate LT
        String s;
