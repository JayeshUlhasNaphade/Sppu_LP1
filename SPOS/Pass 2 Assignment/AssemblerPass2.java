...
public class AssemblerPass2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String s;
        BufferedReader br;
   br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 2 Assignment\\input file\\out_symtable.txt"))); //reading Symbol table
        ...
        br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 2 Assignment\\input file\\out_littable.txt")));//reading literal table
        while ((s = br.readLine()) != null) {
            StringTokenizer st = new StringTokenizer(s, " ", false); //convert line into tokens
        ...
        br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 2 Assignment\\input file\\lclist.txt")));//reading lclist
        while ((s = br.readLine()) != null) {
    ...
    static void initializeTables() throws Exception {
        ...
        String s;
        BufferedReader br;
        br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 2 Assignment\\input file\\mot.txt")));//reading MOT
        while ((s = br.readLine()) != null) {
            StringTokenizer st = new StringTokenizer(s, " ", false); //convert line into tokens
            mot.add(new Tuple(st.nextToken(), st.nextToken(), st.nextToken(), st.nextToken())); //adding token into list
        }
        br = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 2 Assignment\\input file\\pot.txt")));//reading POT
        while ((s = br.readLine()) != null) {
    ...
    static void pass2() throws Exception {
		...
		out_pass2 = new PrintWriter(new FileWriter("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 2 Assignment\\output file\\output_pass2.txt"), true);
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 2 Assignment\\input file\\output_pass1.txt"))); //read output pass 1
		String s; //to be used
		...
		System.out.println("\nPass 2 output:");
		input = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\ADMIN\\Desktop\\SPOS\\SPOS\\Pass 2 Assignment\\output file\\output_pass2.txt")));
